...
{
    public sealed partial class FacebookStreamingPage : Page
    {
        private readonly NativeTwitchStreamingService _streamingService = NativeTwitchStreamingService.FacebookInstance;
        private readonly NativeScreenShareStreamingService _obsCaptureService = NativeScreenShareStreamingService.Instance;
        private const string StreamKeySettingKey = "Zink.Streaming.FacebookStreamKey";
        ...
        public FacebookStreamingPage()
        {
            InitializeComponent();
            Loaded += FacebookStreamingPage_Loaded;
            Unloaded += FacebookStreamingPage_Unloaded;
        }

        private void FacebookStreamingPage_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void FacebookStreamingPage_Unloaded(object sender, RoutedEventArgs e)
        {
            _streamingService.StatusChanged -= StreamingService_StatusChanged;
            _streamingService.StreamingStateChanged -= StreamingService_StreamingStateChanged;
            _streamingService.StatsChanged -= StreamingService_StatsChanged;
        ...
        private async void StartStreamButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                StatusText.Text = "Starting native Facebook Live stream...";
        ...
        private void UpdateStreamingState(bool isStreaming)
        {
            ...
            try
            {
                DiscordPresenceService.Instance.SetStreamingPresence("Facebook Live", isStreaming);
            }
            catch
            {
            }
