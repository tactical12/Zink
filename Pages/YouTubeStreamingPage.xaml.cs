...
{
    public sealed partial class YouTubeStreamingPage : Page
    {
        private readonly NativeTwitchStreamingService _streamingService = NativeTwitchStreamingService.YouTubeInstance;
        private readonly NativeScreenShareStreamingService _obsCaptureService = NativeScreenShareStreamingService.Instance;
        private const string StreamKeySettingKey = "Zink.Streaming.YouTubeStreamKey";
        ...
        public YouTubeStreamingPage()
        {
            InitializeComponent();
            Loaded += YouTubeStreamingPage_Loaded;
            Unloaded += YouTubeStreamingPage_Unloaded;
        }

        private void YouTubeStreamingPage_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void YouTubeStreamingPage_Unloaded(object sender, RoutedEventArgs e)
        {
            _streamingService.StatusChanged -= StreamingService_StatusChanged;
            _streamingService.StreamingStateChanged -= StreamingService_StreamingStateChanged;
            _streamingService.StatsChanged -= StreamingService_StatsChanged;
        ...
        private async void StartStreamButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                StatusText.Text = "Starting native YouTube stream...";
        ...
        private void UpdateStreamingState(bool isStreaming)
        {
            ...
            try
            {
                DiscordPresenceService.Instance.SetStreamingPresence("YouTube", isStreaming);
            }
            catch
            {
            }
