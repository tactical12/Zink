...
{
    public sealed partial class KickStreamingPage : Page
    {
        private readonly NativeTwitchStreamingService _streamingService = NativeTwitchStreamingService.KickInstance;
        private readonly NativeScreenShareStreamingService _obsCaptureService = NativeScreenShareStreamingService.Instance;
        private const string StreamKeySettingKey = "Zink.Streaming.KickStreamKey";
        ...
        public KickStreamingPage()
        {
            InitializeComponent();
            Loaded += KickStreamingPage_Loaded;
            Unloaded += KickStreamingPage_Unloaded;
        }

        private void KickStreamingPage_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void KickStreamingPage_Unloaded(object sender, RoutedEventArgs e)
        {
            _streamingService.StatusChanged -= StreamingService_StatusChanged;
            _streamingService.StreamingStateChanged -= StreamingService_StreamingStateChanged;
            _streamingService.StatsChanged -= StreamingService_StatsChanged;
        ...
        private async void StartStreamButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                StatusText.Text = "Starting native Kick stream...";
        ...
        private void UpdateStreamingState(bool isStreaming)
        {
            ...
            try
            {
                DiscordPresenceService.Instance.SetStreamingPresence("Kick", isStreaming);
            }
            catch
            {
            }
