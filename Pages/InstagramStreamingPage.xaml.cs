...
{
    public sealed partial class InstagramStreamingPage : Page
    {
        private readonly NativeTwitchStreamingService _streamingService = NativeTwitchStreamingService.InstagramInstance;
        private readonly NativeScreenShareStreamingService _obsCaptureService = NativeScreenShareStreamingService.Instance;
        private const string StreamKeySettingKey = "Zink.Streaming.InstagramStreamKey";
        ...
        public InstagramStreamingPage()
        {
            InitializeComponent();
            Loaded += InstagramStreamingPage_Loaded;
            Unloaded += InstagramStreamingPage_Unloaded;
        }

        private void InstagramStreamingPage_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void InstagramStreamingPage_Unloaded(object sender, RoutedEventArgs e)
        {
            _streamingService.StatusChanged -= StreamingService_StatusChanged;
            _streamingService.StreamingStateChanged -= StreamingService_StreamingStateChanged;
            _streamingService.StatsChanged -= StreamingService_StatsChanged;
        ...
        private async void StartStreamButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                StatusText.Text = "Starting native Instagram stream...";
        ...
        private void UpdateStreamingState(bool isStreaming)
        {
            ...
            try
            {
                DiscordPresenceService.Instance.SetStreamingPresence("Instagram", isStreaming);
            }
            catch
            {
            }
