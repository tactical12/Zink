...
{
    public sealed partial class XStreamingPage : Page
    {
        private readonly NativeTwitchStreamingService _streamingService = NativeTwitchStreamingService.XInstance;
        private readonly NativeScreenShareStreamingService _obsCaptureService = NativeScreenShareStreamingService.Instance;
        private const string StreamKeySettingKey = "Zink.Streaming.XStreamKey";
        ...
        public XStreamingPage()
        {
            InitializeComponent();
            Loaded += XStreamingPage_Loaded;
            Unloaded += XStreamingPage_Unloaded;
        }

        private void XStreamingPage_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void XStreamingPage_Unloaded(object sender, RoutedEventArgs e)
        {
            _streamingService.StatusChanged -= StreamingService_StatusChanged;
            _streamingService.StreamingStateChanged -= StreamingService_StreamingStateChanged;
            _streamingService.StatsChanged -= StreamingService_StatsChanged;
        ...
        private async void StartStreamButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                StatusText.Text = "Starting native X Live stream...";
        ...
        private void UpdateStreamingState(bool isStreaming)
        {
            ...
            try
            {
                DiscordPresenceService.Instance.SetStreamingPresence("X Live", isStreaming);
            }
            catch
            {
            }
